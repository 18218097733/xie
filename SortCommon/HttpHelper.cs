...
namespace SortCommon
{
    public class HttpHelper
    {
        ...
        /// <returns></returns>
        public static string HttpPostData(string url, string fileKeyName, string filePath, string filename, System.Collections.Specialized.NameValueCollection stringDict, int timeOut = 900000)
        {
